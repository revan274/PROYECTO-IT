...
interface InventoryViewProps {
  ...
  eliminarActivo: (id: number, e: React.MouseEvent) => void;
}

export const InventoryView: React.FC<InventoryViewProps> = ({
  inventoryImportInputRef, handleImportInventory, canEdit, isImportingInventory,
  exportarInventarioFiltrado, setQrManualInput, setQrScannerStatus, setShowQrScanner,
  canManageUsers, activos, eliminarTodosActivos, openModal, activosConIp,
  activosEvaluablesIp, activosConMac, activosEvaluablesMac, activosSinResponsable,
  activosEvaluablesResponsable, activosVidaAlta, inventoryDepartmentFilter,
  setInventoryDepartmentFilter, departamentoOptions, inventoryEquipmentFilter,
  setInventoryEquipmentFilter, equipoOptions, inventoryStatusFilter,
  setInventoryStatusFilter, inventoryRiskFilter, setInventoryRiskFilter,
  inventorySortField, setInventorySortField, inventorySortDirection,
  setInventorySortDirection, setSearchTerm, applyInventoryFocus, activosEnFalla,
  duplicateIpEntries, duplicateMacEntries, updateInventorySort, getInventorySortIndicator,
  sortedFilteredActivos, setSelectedAsset, eliminarActivo
}) => {
  return (
    <>
