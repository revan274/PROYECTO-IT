...
import type { Insumo, SupplyAuditMovement } from '../../types/app';
...
export const SuppliesView: React.FC<SuppliesViewProps> = ({
  canEdit, openModal, supplySummary, supplySearchTerm, setSupplySearchTerm,
  supplyCategoryFilter, setSupplyCategoryFilter, supplyCategoryOptions,
  supplyStatusFilter, setSupplyStatusFilter, filteredSupplies, insumos,
  reponerCriticos, getSupplyHealthStatus, supplyAuditMovementsByInsumoId,
  openInsumoEditModal, eliminarInsumo, formatDateTime, setSelectedSupplyHistoryItem,
  ajustarStock, supplyStockDrafts, setSupplyStockDrafts, confirmarStockManual
}) => {
  return (
    <>
