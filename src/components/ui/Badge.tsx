...
export function Badge({ children, variant }: BadgeProps) {
  const styles: Record<string, string> = {
    ...
    presencial_fuera_de_horario: 'bg-sky-100 text-sky-800 border-sky-200',
    remoto: 'bg-violet-50 text-violet-700 border-violet-100',
    remoto_fuera_de_horario: 'bg-fuchsia-100 text-fuchsia-800 border-fuchsia-200',
    traslado: 'bg-emerald-50 text-emerald-700 border-emerald-100',
