...
export function AssetDetailModal({
  ...
  return (
    <ModalDialog
      ...
      className="bg-white w-full max-w-4xl rounded-[3rem] shadow-2xl overflow-hidden max-h-[86vh] flex flex-col"
    >
        <div className="bg-slate-800 text-white p-8 md:p-10 flex justify-between items-start">
          <div>
            <h2 id={titleId} className="text-3xl font-black uppercase leading-none">{asset.tag}</h2>
          ...
          <Button
            ...
            aria-label={`Cerrar detalles de ${asset.tag}`}
          >
            <X />
          </Button>
        </div>
