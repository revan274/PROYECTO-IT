...
import { resolveAssetBranchCode } from '../utils/assets';
import { escapeHtml } from '../utils/format';

/**
 * Genera el HTML de la etiqueta QR imprimible (60mm x 40mm) de un activo.
 * Función pura: datos → string HTML.
 */
export function buildAssetQrLabelHtml(
  asset: Activo,
  qrDataUrl: string,
